...
public class GuestEntityCommandAdapter implements SaveGuestPort {
    private final GuestEntityJpaRepository guestEntityJpaRepository;
    private final GuestMapper guestMapper;

    @Override
    public Guest save(GuestSave domain) {
        GuestEntity entity = guestMapper.toEntity(domain);
        GuestEntity saved = guestEntityJpaRepository.save(entity);
